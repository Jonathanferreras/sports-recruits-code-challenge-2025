...
CREATE TABLE users (
  ...
  user_type text CHECK (user_type IN ('player','coach')),
  first_name varchar(255),
  last_name varchar(255),
  ranking smallint DEFAULT 3 CHECK (ranking >= 0 AND ranking <= 255),
  can_play_goalie smallint DEFAULT 0 CHECK (can_play_goalie IN (0,1))
);

-- Data
INSERT INTO users (id, user_type, first_name, last_name, ranking, can_play_goalie) VALUES
...
-- Make sure the identity sequence is in sync with the max(id)
